...
@Component({
  ...
  imports: [CommonModule, PillButtonComponent, BottomNavComponent],
  template: `
    <div class="rdetail">
        ...
        <div class="rdetail__hero-body" *ngIf="detail">
          ...
          <div class="rdetail__route-path">
            ...
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none">
              <path d="M5 12h14M12 5l7 7-7 7" stroke="rgba(255,255,255,.7)" stroke-width="2" stroke-linecap="round"/>
            </svg>
      ...
      <div class="rdetail__scroll" *ngIf="detail">
        ...
        <div class="rdetail__section">
          ...
          <div class="rdetail__cond-item">
            <div class="rdetail__cond-icon">🛣️</div>
          ...
          <div class="rdetail__cond-item">
            <div class="rdetail__cond-icon">🚦</div>
            <div class="rdetail__cond-info">
      ...
      <div class="rdetail__bottom">
        <app-pill-button variant="primary" [block]="true" (click)="startNav()">
          ▶ Iniciar navegación
        </app-pill-button>
      </div>

      <app-bottom-nav active="destination"></app-bottom-nav>
    </div>
  `,
...
export class RouteDetailComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  startNav(): void { this.router.navigate(['/map/active']); }
}

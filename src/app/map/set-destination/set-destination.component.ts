  ...
  template: `
    <div class="set-dest">
      ...
      <div class="set-dest__form">
        ...
        <div style="padding:0 18px"><div style="height:1.5px;background:#dee2e6"></div></div>
        <div class="set-dest__input-row" [class.set-dest__input-row--active]="showSuggestions">
          ...
          <input class="set-dest__input" [(ngModel)]="destination"
            ...
            (focus)="onFocus()"
            (blur)="onBlur()"/>
          <button *ngIf="destination" class="set-dest__locate-btn" style="color:#e74c3c"
      ...
      <div class="set-dest__autocomplete" *ngIf="showSuggestions && (suggestions.length > 0 || destination.length > 1)">
        ...
        <div style="padding:6px 12px;font-size:10px;color:#adb5bd;text-align:right">
      ...
      <div class="set-dest__map">
        ...
        <div class="set-dest__route-overlay" *ngIf="loadingRoute">
          ...
          <div style="font-size:14px;font-weight:700;color:#0d7377">Calculando ruta real...</div>
          <div style="font-size:12px;color:#6c757d;margin-top:3px">Via OSRM OpenStreetMap</div>
        </div>

...
export class VehicleSelectionComponent {
  ...
  conditions = [
    { icon: '🕳️', label: 'Baches y calles en mal estado', checked: true },
    { icon: '🪨',  label: 'Calles no pavimentadas',        checked: true },
    { icon: '🌊',  label: 'Inundaciones temporales',       checked: false },
    { icon: '🏗️',  label: 'Obras en construcción',        checked: false },
  ];

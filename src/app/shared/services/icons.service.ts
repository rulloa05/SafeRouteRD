...
export class IconsService {
  ...
  // ── Condiciones de ruta (vehicle-selection) ──────────────────────────
  conditionSvg(key: string): SafeHtml {
    const svgs: Record<string, string> = {
      bache: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path d="M5 18 Q8 13 12 18 Q16 23 19 18" stroke="#e67e22" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M9 8 L12 4 L15 8" stroke="#e67e22" stroke-width="1.8" fill="none" stroke-linecap="round" stroke-linejoin="round"/><ellipse cx="12" cy="20" rx="6" ry="2.5" fill="#e67e22" opacity=".2"/></svg>`,
      pavimento: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><ellipse cx="9" cy="16" rx="4" ry="3" fill="#8b7355" opacity=".8"/><ellipse cx="17" cy="14" rx="3" ry="2.5" fill="#a0896b" opacity=".8"/><ellipse cx="13" cy="19" rx="3.5" ry="2.5" fill="#6b5a3e" opacity=".7"/><ellipse cx="6" cy="11" rx="2.5" ry="2" fill="#8b7355" opacity=".6"/><ellipse cx="18" cy="19" rx="2.5" ry="2" fill="#a0896b" opacity=".6"/></svg>`,
      inundacion: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><path d="M4 19 Q7 15 10 19 Q13 23 16 19 Q19 15 22 19" stroke="#3498db" stroke-width="2" fill="none" stroke-linecap="round"/><path d="M4 14 Q7 10 10 14 Q13 18 16 14 Q19 10 22 14" stroke="#3498db" stroke-width="1.5" fill="none" stroke-linecap="round" opacity=".5"/><path d="M12 3 L12 9 M9 6 L12 3 L15 6" stroke="#3498db" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
      obra: `<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="20"><rect x="4" y="12" width="16" height="2.5" rx="1" fill="#f39c12"/><rect x="7" y="14.5" width="2.5" height="6" fill="#f39c12" opacity=".7"/><rect x="14.5" y="14.5" width="2.5" height="6" fill="#f39c12" opacity=".7"/><path d="M10 4 L12 2 L14 4 L13 4 L13 12 L11 12 L11 4Z" fill="#e67e22"/></svg>`,
    };
    return this.safe(svgs[key] ?? svgs['bache']);
  }
